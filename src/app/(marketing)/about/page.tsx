...
export const metadata: Metadata = {
  title: "About 1Herb",
  description:
    "Learn about 1Herb, our mission, and how we help you make informed decisions about medicinal herbs.",
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4 text-muted-foreground">
          <p>
            1Herb is a comprehensive digital platform designed to provide
          ...
          <p>
            ...
            individual exploring natural wellness options, 1Herb provides the
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4 text-muted-foreground">
          <p>
            1Herb is completely free to use with no limits, no paywalls,
          ...
          <p>
            If 1Herb has been helpful to you, please consider{" "}
            <a
              href="/donate"
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          1Herb is developed by a dedicated team of software engineers,
