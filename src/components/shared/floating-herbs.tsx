...
const leaves = [
  {
    ...
    className:
      "absolute -top-4 left-[8%] w-16 h-16 animate-float-leaf-1 hidden md:block",
    rotate: "rotate-[-25deg]",
  ...
  },
  {
    ...
    className:
      "absolute top-12 right-[6%] w-20 h-20 animate-float-leaf-2 hidden md:block",
    rotate: "rotate-[15deg]",
  ...
  },
  {
    ...
    className:
      "absolute top-1/2 -left-2 w-14 h-14 animate-float-leaf-3 hidden md:block",
    rotate: "rotate-[45deg]",
  ...
  },
  {
    ...
    className:
      "absolute top-[60%] right-[4%] w-24 h-24 animate-float-leaf-1 hidden md:block",
    rotate: "rotate-[-10deg]",
  ...
  },
  {
    ...
    className:
      "absolute bottom-[15%] left-[12%] w-12 h-12 animate-float-leaf-2 hidden md:block",
    rotate: "rotate-[30deg]",
  ...
  },
  {
    ...
    className:
      "absolute bottom-[25%] right-[15%] w-16 h-16 animate-float-leaf-3 hidden md:block",
    rotate: "rotate-[-40deg]",
