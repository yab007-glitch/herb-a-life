...
export const HIGH_PRIORITY_HERBS: MonographTemplate[] = [
  ...
  },
  {
    slug: "collagen",
    name: "Collagen",
    scientificName: "Collagen peptides",
    priority: "high",
    category: "joint",
    estimatedHours: 2,
  },
...
export const MEDIUM_PRIORITY_HERBS: MonographTemplate[] = [
  ...
  },
  {
    ...
    scientificName: "Beta-sitosterol",
    priority: "medium",
    category: "prostate",
    estimatedHours: 2,
  },
...
export const TOTAL_ESTIMATED_HOURS = TOP_120_HERBS.reduce(
  (sum, h) => sum + h.estimatedHours,
  0
);
