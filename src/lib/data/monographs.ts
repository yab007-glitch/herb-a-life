// Top 50 herb monographs with deep content
// These enrich the herb detail pages with detailed clinical information

export interface Monograph {
  slug: string;
  summary: string; // Rich 2-3 sentence clinical summary
  mechanism: string; // How it works
  dosageEvidence: { claim: string; evidence: "A" | "B" | "C" | "D" | "trad"; note?: string }[];
  safetyNotes: string[];
...
export const monographs: Record<string, Monograph> = {
  turmeric: {
    ...
    drugInteractions: [
      { drug: "Warfarin and anticoagulants", severity: "severe", detail: "Enhanced anticoagulant effect; INR monitoring essential" },
      { drug: "CYP3A4 substrates", severity: "moderate", detail: "Piperine formulations inhibit CYP3A4, increasing drug levels" },
      { drug: "Diabetes medications", severity: "moderate", detail: "Additive hypoglycemic effect; monitor blood glucose" },
      { drug: "NSAIDs", severity: "mild", detail: "Additive anti-inflammatory effect; may allow dose reduction" },
    ],
    pregnancyCategory: "caution",
    keyCitations: [
      { source: "PubMed", title: "Efficacy of Turmeric Extracts and Curcumin for Alleviating Osteoarthritis Pain", url: "https://pubmed.ncbi.nlm.nih.gov/27056006/", year: 2016 },
      { source: "WHO Monographs", title: "Curcuma longa (Turmeric)" },
      { source: "NCCIH", title: "Turmeric", url: "https://www.nccih.nih.gov/health/turmeric" },
    ],
  },
  ashwagandha: {
    slug: "ashwagandha",
    ...
    drugInteractions: [
      { drug: "Thyroid medications (levothyroxine)", severity: "moderate", detail: "May increase T3/T4 levels; monitor thyroid function" },
      { drug: "Sedatives (benzodiazepines, barbiturates)", severity: "moderate", detail: "Additive sedative effect via GABA potentiation" },
      { drug: "Immunosuppressants", severity: "moderate", detail: "Immunostimulatory effects may oppose immunosuppressive drugs" },
      { drug: "Antidiabetes medications", severity: "mild", detail: "Additive blood glucose lowering; monitor levels" },
    ],
    pregnancyCategory: "unsafe",
    keyCitations: [
      { source: "PubMed", title: "A Prospective, Randomized Double-Blind, Placebo-Controlled Study of Safety and Efficacy of Ashwagandha Root Extract", url: "https://pubmed.ncbi.nlm.nih.gov/23439798/", year: 2012 },
      { source: "Commission E", title: "Withania somnifera" },
      { source: "NCCIH", title: "Ashwagandha", url: "https://www.nccih.nih.gov/health/ashwagandha" },
    ],
  },
  ginger: {
    slug: "ginger",
    ...
    drugInteractions: [
      { drug: "Anticoagulants (warfarin, clopidogrel)", severity: "moderate", detail: "Additive bleeding risk; monitor INR if using high doses" },
      { drug: "Antidiabetes medications", severity: "mild", detail: "Additive glucose lowering effect" },
    ],
    pregnancyCategory: "safe",
    keyCitations: [
      { source: "WHO Monographs", title: "Zingiber officinale (Ginger)", url: "https://apps.who.int/medicine/en/" },
      { source: "Commission E", title: "Ginger Root" },
      { source: "PubMed", title: "Ginger for Nausea and Vomiting of Pregnancy: A Systematic Review", url: "https://pubmed.ncbi.nlm.nih.gov/24901824/", year: 2014 },
    ],
  },
  chamomile: {
    slug: "chamomile",
    ...
    drugInteractions: [
      { drug: "Warfarin and anticoagulants", severity: "mild", detail: "Theoretical coumarin content; no clinical cases at tea doses" },
      { drug: "Sedatives", severity: "mild", detail: "Additive sedative effect; may enhance drowsiness" },
    ],
    pregnancyCategory: "safe",
    keyCitations: [
      { source: "WHO Monographs", title: "Matricariae Flos (Chamomile Flower)" },
      { source: "Commission E", title: "Chamomile Flower" },
      { source: "PubMed", title: "Chamomile: A Herbal Medicine of the Past with Bright Future", url: "https://pubmed.ncbi.nlm.nih.gov/20944934/", year: 2010 },
    ],
  },
  echinacea: {
    slug: "echinacea",
    ...
    drugInteractions: [
      { drug: "Immunosuppressants", severity: "moderate", detail: "Counteracts immunosuppressive therapy; avoid concurrent use" },
      { drug: "Caffeine", severity: "mild", detail: "May slow caffeine metabolism" },
    ],
    pregnancyCategory: "caution",
    keyCitations: [
      { source: "Commission E", title: "Echinacea purpurea Herb" },
      { source: "NCCIH", title: "Echinacea", url: "https://www.nccih.nih.gov/health/echinacea" },
      { source: "PubMed", title: "Echinacea for Treating the Common Cold: A Randomized Trial", url: "https://pubmed.ncbi.nlm.nih.gov/19692721/", year: 2009 },
    ],
  },
  "valerian-root": {
    slug: "valerian-root",
    ...
    drugInteractions: [
      { drug: "Sedatives (benzodiazepines, Z-drugs)", severity: "severe", detail: "Additive CNS depression; avoid combination" },
      { drug: "Alcohol", severity: "moderate", detail: "Additive sedative effect" },
      { drug: "Antidepressants (SSRIs, SNRIs)", severity: "mild", detail: "Theoretical serotonin interaction; monitor" },
    ],
    pregnancyCategory: "unsafe",
    keyCitations: [
      { source: "Commission E", title: "Valerian Root" },
      { source: "WHO Monographs", title: "Valerianae Radix" },
      { source: "PubMed", title: "Valerian for Sleep: A Systematic Review and Meta-Analysis", url: "https://pubmed.ncbi.nlm.nih.gov/16981943/", year: 2006 },
    ],
  },
  "milk-thistle": {
    slug: "milk-thistle",
    ...
    drugInteractions: [
      { drug: "CYP3A4 substrates (many drugs)", severity: "moderate", detail: "Silymarin inhibits CYP3A4; may increase levels of substrate drugs" },
      { drug: "CYP2C9 substrates (warfarin, NSAIDs)", severity: "moderate", detail: "May increase drug levels via CYP inhibition" },
      { drug: "Antidiabetes medications", severity: "mild", detail: "Additive glucose lowering effect" },
    ],
    pregnancyCategory: "caution",
    keyCitations: [
      { source: "Commission E", title: "Milk Thistle Fruit" },
      { source: "WHO Monographs", title: "Silybi Mariae Fructus" },
      { source: "PubMed", title: "Silymarin for Liver Disease: A Systematic Review and Meta-Analysis", url: "https://pubmed.ncbi.nlm.nih.gov/30570540/", year: 2018 },
    ],
  },
};
