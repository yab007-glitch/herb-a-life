...
export const premiumMonographs: Record<string, Monograph> = {
  ...
  "st-johns-wort": {
    ...
    claims: [
      ...
      {
        claim: "Menopausal mood symptoms",
        evidence: "C",
        note: "Preliminary evidence",
      },
      {
        claim: "Topical antimicrobial",
        evidence: "B",
        note: "Hypericin has antiviral properties",
      },
    ],
    safetyNotes: [
    ...
    drugInteractions: [
      {
        ...
        detail: "Reduced efficacy; use alternative contraception",
      },
      {
        drug: "Antidepressants (SSRIs/MAOIs/TCAs)",
        severity: "contraindicated",
      ...
      {
        drug: "HIV medications (protease inhibitors)",
        severity: "contraindicated",
        detail: "Reduced drug levels via CYP3A4 induction",
      },
      {
        drug: "Cyclosporine",
        severity: "contraindicated",
        detail: "Reduced immunosuppression; organ rejection risk",
      },
      {
        drug: "Digoxin",
        severity: "severe",
        detail: "Reduced digoxin levels via P-gp induction",
      },
      {
        drug: "Statins",
        severity: "moderate",
        detail: "Reduced statin efficacy",
      },
      {
        drug: "Calcium channel blockers",
        severity: "moderate",
        detail: "Reduced antihypertensive effect",
      },
    ],
    pregnancyCategory: "unsafe",
    keyCitations: [
      ...
      {
        source: "JAMA",
        title: "Effect of Hypericum perforatum vs sertraline",
        url: "https://jamanetwork.com",
        year: 2001,
      },
      {
  ...
  "saw-palmetto": {
    slug: "saw-palmetto",
    summary:
      "Saw Palmetto (Serenoa repens) is the leading herbal treatment for benign prostatic hyperplasia (BPH), with over 2 million men in the U.S. using it for urinary symptoms. Liposterolic extracts (85-95% fatty acids and sterols) are the standardized form. While widely used, evidence is mixed: early trials showed benefit comparable to finasteride, but recent high-quality trials (including the STEP trial) have been negative. The discrepancy may relate to extract quality and baseline symptom severity.",
    mechanism:
      "Liposterolic extract inhibits 5-alpha-reductase (types I and II), reducing conversion of testosterone to dihydrotestosterone (DHT). It also has anti-inflammatory effects via COX and LOX inhibition, and anti-edematous properties. Beta-sitosterol and campesterol are key sterols. Saw palmetto demonstrates anti-androgenic effects at the prostate receptor level. Unlike finasteride, it doesn't significantly lower PSA levels, making it useful for men undergoing prostate cancer screening.",
    claims: [
      {
        claim: "BPH symptoms (LUTS)",
        evidence: "B",
        note: "Mixed evidence; earlier positive trials vs. recent negative ones",
      },
      {
        claim: "Nocturia",
        evidence: "C",
        note: "May reduce nighttime urination frequency",
      },
      {
        claim: "Sexual function preservation",
        evidence: "B",
        note: "Unlike finasteride, no negative sexual side effects",
      },
      {
        claim: "Prostate cancer prevention",
        evidence: "D",
    ...
    drugInteractions: [
      {
        ...
        severity: "mild",
        detail: "May have additive effects; avoid concurrent use",
      },
      {
        drug: "Anticoagulants",
        severity: "mild",
        detail: "Theoretical antiplatelet effect",
      },
      {
        drug: "Hormone replacement therapy",
        severity: "mild",
        detail: "Possible additive hormonal effects",
      },
    ],
    pregnancyCategory: "unsafe",
    keyCitations: [
  ...
  "green-tea": {
    ...
    claims: [
      ...
      },
      {
        ...
        evidence: "C",
        note: "Promising preclinical; mixed clinical evidence",
      },
      {
        claim: "Dental health",
        evidence: "B",
        note: "Antibacterial effects reduce caries and gingivitis",
      },
      {
        claim: "Liver protection",
        evidence: "C",
        note: "Preliminary evidence for NAFLD",
      },
    ],
    safetyNotes: [
    ...
    drugInteractions: [
      {
        drug: "Warfarin",
        severity: "moderate",
        detail: "High amounts of vitamin K in tea leaves",
      },
      {
        drug: "Hepatotoxic drugs",
        severity: "moderate",
        detail: "High-dose extract may add to liver burden",
      },
      {
        drug: "Stimulants",
        severity: "mild",
        detail: "Additive caffeine effects",
      },
      {
        drug: "Iron supplements",
        severity: "mild",
        detail: "Tannins reduce iron absorption",
      },
    ],
    ...
    keyCitations: [
      ...
      {
        source: "J Nutr",
        title: "Tea catechins and cognitive function",
        year: 2014,
      },
    ],
  },
    ...
    drugInteractions: [
      {
        drug: "Digoxin",
        severity: "moderate",
        detail: "May falsely elevate digoxin levels",
      },
      {
        drug: "Anticoagulants",
        severity: "mild",
      ...
      },
      {
        drug: "Hypoglycemics",
        severity: "mild",
        detail: "May affect blood glucose",
      },
      {
        drug: "Stimulants",
        severity: "mild",
        detail: "Possible additive effects",
      },
    ],
    pregnancyCategory: "unsafe",
    keyCitations: [
      {
        source: "Phytomedicine",
        title: "Eleutherococcus for stress adaptation",
        url: "https://www.sciencedirect.com",
        year: 2005,
      },
      {
        source: "J Ethnopharmacol",
        title: "Immunomodulatory effects of eleutherococcus",
        year: 2009,
      },
      {
        source: "Chin J Integr Med",
        title: "Eleutherococcus and fatigue",
        year: 2011,
      },
